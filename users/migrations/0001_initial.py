...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Lecturer',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='lecturer', serialize=False, to='users.user')),
            ],
        ),
        migrations.CreateModel(
            name='Practicer',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='practicer', serialize=False, to='users.user')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
                ...
                ('lecturer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='users.lecturer')),
                ('practicer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='users.practicer')),
            ],
        ),
    ]
